...
public class AddFuncionario extends javax.swing.JPanel {
    ...
    * Creates new form AddFuncionario
    ...
    public AddFuncionario(JFrame frame) {
        ...
        this.setBorder(E);
        adicionarValidacaoApenasAlfabeto(txNome);
        adicionarValidacaoApenasAlfabeto(txApelido);
        restrictToNumbersAndDot(txContacto);
        restrictToNumbersAndDot(txSalario);
...
//        });
    ...
    public static void restrictToNumbersAndDot(JTextField textField) {
    ...
    public static void adicionarValidacaoApenasAlfabeto(JTextField textField) {
        textField.addKeyListener(new KeyAdapter() {
            @Override
            public void keyTyped(KeyEvent e) {
                char c = e.getKeyChar();
                if (!Character.isLetter(c)&& e.getKeyCode()!=8) {
                    e.consume(); // Ignora a entrada de caracteres que não sejam letras do alfabeto
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (txNome.getText().isEmpty() || txApelido.getText().isEmpty() || txContacto.getText().isEmpty() || txEmail.getText().isEmpty() || txIdentidade.getText().isEmpty() || txSalario.getText().isEmpty()) {
            ...
            if (cCategoria.getSelectedItem().toString().equalsIgnoreCase("vendedor")) {
                ...
                a.setIdade(b.get(Calendar.YEAR) - dateChooser1.getSelectedDate().getYear());
                ...
                openFile.get(0).setDispesas(openFile.get(0).getDispesas() + Double.parseDouble(txSalario.getText()));
