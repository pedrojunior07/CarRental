...
public class AddCarro extends javax.swing.JPanel {
  ...
  JnaFileChooser jnaCh; 
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 30, 170, -1));
        ...
        cTipCombus.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        ...
        txKMPercoridos.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        ...
        cCambio.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        ...
        cFornecedor.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      if((Double.parseDouble(txPreco.getText()))>openFile.get(0).getSaldo()){
      
          JOptionPane.showMessageDialog(txModelo, "Saldo Insuficiente", "Confre", JOptionPane.ERROR_MESSAGE);
       ...
       c.setFornecedorId(v.getID());
        ...
        GerenteController cc = new GerenteController(frame);
          ...
          ImagemDirectorioDAO dao1 = new ImagemDirectorioDAO();
        
           icons.setChassi(Integer.parseInt(txNumChassi.getText()));
          
         dao1.insert(icons, "Imagens");
      
        
      try {
          cc.insertCarrro(c);
          openFile.get(0).setSaldo((openFile.get(0).getSaldo()-Double.parseDouble(txPreco.getText())));
          dao.insert( openFile.get(0));
          
          StockTaxasDao daaa = new StockTaxasDao();
            ArrayList<StockeTaxas> openFile1 = daaa.openFile();
            int qntToTalCarros = openFile1.get(0).getQntToTalCarros();
            openFile1.get(0).setQntToTalCarros((qntToTalCarros+1));
            daaa.InsertTax(  openFile1.get(0));
