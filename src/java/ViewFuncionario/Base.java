...
import com.pedro.radial_menu.EventRadialMenu;
import com.pedro.radial_menu.RadialItem;
...
public class Base extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Butons.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        ...
        getContentPane().add(Butons, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 260, 680));

        Base2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        getContentPane().add(Base2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 950, 680));
